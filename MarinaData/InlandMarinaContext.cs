    ...
    public class InlandMarinaContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Customer>().HasData(
                new Customer { ID = 1, Username="jdoe", Password="password", FirstName = "John", LastName = "Doe", Phone = "265-555-1212", City = "Phoenix" },
                new Customer { ID = 2, Username="swillaims", Password="password", FirstName = "Sara", LastName = "Williams", Phone = "403-555-9585", City = "Calgary" },
                new Customer { ID = 3, Username="kwong", Password="password", FirstName = "Ken", LastName = "Wong", Phone = "802-555-3214", City = "Kansas City" }
            );
